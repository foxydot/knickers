...
function msdlab_homepage_footer(){
    if(is_active_sidebar('homepage-footer-1')){
        print '<div id="hp-footer-1">';
        print '<div class="wrap">';
        dynamic_sidebar('homepage-footer-1');
        print '</div>';
        print '</div>';
    }
    if(is_active_sidebar('homepage-footer-2')){
        print '<div id="hp-footer-2">';
        print '<div class="wrap">';
        dynamic_sidebar('homepage-footer-2');
        print '</div>';
        print '</div>';
    }
}
