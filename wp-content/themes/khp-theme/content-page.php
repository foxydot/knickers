...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php 	if(is_home() || is_front_page()){?>
        ...
        <div id="tweeter">
   			<div id="custom"><?php echo do_shortcode("[tweetomatic title='Tweets' show_timestamp='true' show_powered_by='false' count='3']"); ?></div>
            <!--<div id="custom"><?php //echo do_shortcode("[twitter-feed username='KnickersofHP' id='352436574304235520' mode='feed']"); ?></div> -->
