        ...
        */
        ...
        function codex_custom_help_tab() {
          ...
          $args = array(
            ...
            'title'   => 'Event Date', //unique visible title for the tab
            'content' => '<h3>The Event Date</h3>
          ...
          $args = array(
            ...
            'content' => '<h3>The Event Venue</h3>
                          ...
                          <h3>Venue Address</h3>
                          <p>The Venue Address is displayed on the single event display and is used to generate the Google map address.</p>',  //actual help text
          );
